...
const SupervisorVivaDashboard = () => {
    ...
    const fetchDashboard = async () => {
        try {
            const res = await fetch(`/api/viva/my-dashboard/supervisor/${userId}`);
    ...
    const handleSaveAvailability = async (periodId, selectedSlots) => {
        try {
            const res = await fetch(`/api/viva/periods/${periodId}/availability`, {
                ...
                body: JSON.stringify({ supervisor_id: userId, slots: selectedSlots })
            });
            if (res.ok) {
    ...
    return (
        <div className="viva-container">
            <div className="viva-header">
                <div>
                    <h1 className="viva-title">My Viva Schedules (Supervisor)</h1>
                    <p className="viva-subtitle">Manage your Viva availability and view confirmed schedules for your students.</p>
                </div>
            </div>
